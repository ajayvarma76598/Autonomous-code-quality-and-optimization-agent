...
def upload_to_langfuse(dataset_items: list, dataset_name: str = "golden-eval-v1"):
    ...
    if not langfuse.auth_check():
        print("Error: Langfuse authentication failed. Check your environment variables.")
        return
...
if __name__ == "__main__":
    ...
    parser.add_argument("--file", type=str, required=True, help="Path to golden_dataset.md")
    parser.add_argument("--name", type=str, default="golden-eval-v1", help="Name of the dataset in Langfuse")
