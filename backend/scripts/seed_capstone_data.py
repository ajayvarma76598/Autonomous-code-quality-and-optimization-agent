...
def seed_data():
    ...
    try:
        ...
        files_data = [
            {
                "repo_idx": 0, "name": "PaymentProcessor.java", 
                "lines": 520, "complexity": 18.4, "maintain": 72.5, "smells": 5, "vuln": 0, "cov": 81.2
            },
            {
                "repo_idx": 1, "name": "data_pipeline.py", 
                "lines": 410, "complexity": 15.2, "maintain": 78.3, "smells": 3, "vuln": 0, "cov": 85.6
            },
            {
                "repo_idx": 2, "name": "AuthManager.java", 
                "lines": 360, "complexity": 19.1, "maintain": 68.7, "smells": 7, "vuln": 1, "cov": 74.4
            },
            {
                "repo_idx": 3, "name": "dashboardController.js", 
                "lines": 280, "complexity": 12.3, "maintain": 82.1, "smells": 2, "vuln": 0, "cov": 88.9
            }
        ]
        ...
        # Performance Logs
        perf_data = [
            {"repo_idx": 0, "svc": "payment-service", "avg": 220, "peak": 780, "err": 0.8, "tps": 320},
            {"repo_idx": 1, "svc": "analytics-engine", "avg": 480, "peak": 1200, "err": 1.2, "tps": 150},
            {"repo_idx": 2, "svc": "auth-service", "avg": 180, "peak": 450, "err": 0.4, "tps": 410},
            {"repo_idx": 3, "svc": "dashboard-api", "avg": 260, "peak": 600, "err": 0.6, "tps": 290}
        ]
