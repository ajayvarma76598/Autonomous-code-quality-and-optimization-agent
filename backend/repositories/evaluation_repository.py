...
from backend.database.models.models import EvaluationResult, EvaluationRun
        ...
        try:
            ...
            if workflow_id:
                eval_run = (
                    ...
                    .filter(EvaluationRun.workflow_id == workflow_id)
                    .first()
                )
            ...
            logger.info(
                f"Successfully persisted evaluation metrics for workflow {workflow_id}"
            )
            return eval_result
