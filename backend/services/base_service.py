...
class ServiceResult(BaseModel):
    ...
    data: Optional[Any] = Field(default=None, description="The payload returned by the service.")
...
class BaseService:
    ...
    def execute(self, func: Callable, *args, **kwargs) -> ServiceResult:
        ...
        try:
            ...
            self.logger.info(f"Successfully executed {func.__name__} in {duration_ms:.2f}ms")
