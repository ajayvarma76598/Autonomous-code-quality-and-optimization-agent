...
@tool
def hybrid_search(query: str, query_embedding: List[float] = None, top_k: int = 5) -> List[Dict[str, Any]]:
    """
    ...
    try:
        ...
        return [r.model_dump() if hasattr(r, "model_dump") else r.dict() if hasattr(r, "dict") else r for r in results]
    finally:
        db.close()
